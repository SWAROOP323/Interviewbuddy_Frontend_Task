...
export const initialUsers: User[] = [
  ...
  { id: 1, name: 'Dave Richards', email: 'dave@mail.com', contact: '+91 8332883854' /* other fields with default/empty values */, basicInfo: {} as BasicInfo, education: {} as EducationDetails, skillsProjects: {} as SkillsProjects, workExperience: [], linkedIn: '', resume: '' },
